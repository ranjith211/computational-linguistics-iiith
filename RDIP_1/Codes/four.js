...
function viewcorpus(){
	...
	if(a=="Corpus1"){
		...
		document.getElementById("two").innerHTML="<table><tr><td>"+"#tokens:"+"</td><td>"+"<input type='text'>"+"</td></tr><tr><td>"+"#types:"+"</td><td>"+"<input type='text'>"+"</td></tr></table>";
		document.getElementById("three").innerHTML="<button>Submit</button>"
	}
	if(a=="Corpus2"){
